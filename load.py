...
def load_data_to_redis(redis_client, slot_prefix_map, start_slot, end_slot, keys_per_slot=10, pipeline_batch_size=1000):
    ...
    for slot in range(start_slot, end_slot + 1):
        ...
        if not prefix:
            print(f"Couldn't find prefix for Slot {slot}, skipping.")
            continue
...
def main():
    ...
    parser.add_argument("--keys-per-slot", type=int, default=10)
    ...
    slot_prefix_map = build_slot_prefix_map_from_embedded()
    r = redis.Redis(host=args.host, port=args.port)

    load_data_to_redis(
        redis_client=r,
        slot_prefix_map=slot_prefix_map,
